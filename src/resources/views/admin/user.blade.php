              ...
              <tbody>
                @foreach ($users as $user)
                  <tr>
                    ...
                    <td>{{ $user->user_gender == 1 ? '남자' : '여자' }}</td>
                    ...
                    <td>{{ $user->user_marketing_agreement == 0 ? '동의' : '비동의' }}</td>
                    <td>{{ $user->user_email_agreement == 0 ? '동의' : '비동의' }}</td>
                    <td>{{ $user->created_at->format('y-m-d') }}</td>
                    <td>
                      <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#basicModal">처리</button>
