            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">계정만들기</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">약관동의 <a href="#">ㄱㄴㄷㄹ</a></label>
                        <div class="invalid-feedback">제출하기 전에 동의해야 합니다.</div>
                      </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">이미 계정을 가지고 계십니까? <a href="pages-login.html">로그인</a></p>
                    </div>
                  </form>
                </div>
              </div>
