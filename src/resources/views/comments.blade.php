        ...
        <div class="table-responsive">
            ...
            <tbody>
                @forelse($data as $key => $val)
                    <tr>
                    <td>{{$data[$key]->comment_id}}</td>
                    <td>{{($data[$key]->comment_type === '0') ? '축제정보' : '축제톡톡' }}</td>
                    <td><a href="/board/{{$data[$key]->board_id}}">{{$data[$key]->comment_content}}</a></td>
