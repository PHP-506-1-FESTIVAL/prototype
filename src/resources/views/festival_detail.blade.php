...
<div class="detailall">
    ...
    <div class="festival-detail">
        <div class="div1">
            <h1>축제정보</h1>
            <h2>{{ $festival->festival_title }} @if (isset($jjmFlg[0]->favorite_id)) 💖 @else 🤍 @endif {{ $favoriteCount }}</h2>
            @php
                $today = date('Y-m-d');
