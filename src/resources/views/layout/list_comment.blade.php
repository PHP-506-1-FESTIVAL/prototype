                    ...
                    <div class="post-details">
                        ...
                        <div class="comment-form">
                            ...
                            <form action="{{ route('comment.create') }}" method="POST">
                                ...
                                <input type="hidden" name="festival_id">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="single-inner">
                    <div class="post-details">
                        ...
                        <div class="comment-form">
                            <h3 class="comment-reply-title"><span>축제 TALK</span></h3>
                            <form id="comment-form" action="{{ route('comment.create') }}" method="POST">
                                @csrf
                                <input type="hidden" name="type_flg" value="0">
                                <input type="hidden" name="festival_id" value="
                                <?php
                                // 현재 URL 가져오기
                                $currentUrl = $_SERVER['REQUEST_URI'];
                                $numericPart = preg_replace('/[^0-9]/', '', $currentUrl);
                                echo $numericPart;
                                ?>
                                ">
                                <textarea name="comment_content" class="form-control" placeholder="댓글을 입력하세요" required></textarea>
