            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-footer f-link">
                        <h5 style="color:#ffffff; margin-bottom:5px;">Team</h5>
                        <p><a href="https://github.com/PHP-506-1-FESTIVAL" style="color:#ffffff; text-decoration-line: none;">여기어때요, 좋조?</a></p>
                        <div class="col-lg-6 col-md-6 col-12">
                            <ul style="display: flex; justify-content: space-between; padding: 0;">
                                <li style="font-size: 30px;"><a href="https://github.com/leegawon0">이가원</a></li>
                                <li style="font-size: 30px;"><a href="https://github.com/xellos88">박진영</a></li>
                                <li style="font-size: 30px;"><a href="https://github.com/rlawotjd">김재성</a></li>
                                <li style="font-size: 30px;"><a href="https://github.com/shinnewjean">신유진</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12" style="margin-top:15px;">
                    ...
                    <ul style="color:#ffffff;"><br>
                        <li><i class="lni lni-pin"></i>대구광역시 중구 중앙대로 394, 제일빌딩 5F</li>
                        <li><i class="lni lni-phone"></i> 053.572.1005</li>
                        <li><i class="lni lni-display-alt"></i>기업요구를반영한PHP풀스택(프론트앤드+백앤드)개발자양성과정</li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="col-12">
                        <div class="content">
                            <p class="copyright-text">
                                ...
                                <a href="https://github.com/PHP-506-1-FESTIVAL/prototype" rel="nofollow" target="_blank">Yogiotteyo,Jocho?</a>
                            </p>
                        </div>
                    </div>
                </div>
