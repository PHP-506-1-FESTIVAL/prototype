...
<form action="">
    {{-- // 게시판 수정 item (상세base) --}}
    <div>
        <input type="text" value="{{$board_edit_data->board_title}}" class="form-control mt-3 mb-0 p-0 rounded-3 form-floating fs-2" size=80>
        <hr>
        ...
        {{-- // 게시판 상세 BUTTON --}}
        <a href=""><button class="btn btn-primary" type="button">수정</button></a>
    ...
    {{-- // 게시판 상세 내용 --}}
    <textarea rows="15" class="form-control content mt-4 rounded-3 border border-secondary p-3" id="exampleFormControlTextarea1">{{$board_edit_data->board_content}}</textarea>
    {{-- <input type="text" value="{{$board_edit_data->board_content}}" class="content mt-4 rounded-3 border border-secondary p-3 form-floating"> --}}
</form>
</div>
