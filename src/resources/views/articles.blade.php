            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">작성 글 목록</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-menu">
                            <ul>
                                ...
                                <li><a class="active" href="{{route('user.articles')}}"><i class="lni lni-pencil"></i> 작성 글 목록</a></li>
                ...
                <div class="col-lg-9 col-md-12 col-12">
                    <div class="main-content">
                        <div class="dashboard-block mt-0">
                            <h3 class="block-title">작성 글 목록</h3>
                            <!-- Start Items Area -->
                            <div class="my-items">
                                <!-- Start List Title -->
                                ...
                                <div class="single-item-list">
                                    <div class="row align-items-center">
                                        <div class="col-lg-2 col-md-3 col-12">
                                            <p>{{$data[$key]->board_id}}</p>
                                        </div>
                                        <div class="col-lg-6 col-md-5 col-12">
                                            <p><a href="/board/{{$data[$key]->board_id}}" style="color:#888;">{{$data[$key]->board_title}}</a></p>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-12">
                                            <p>{{substr($data[$key]->created_at, 0, 10)}}</p>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-12 align-right">
                                            <p>{{$data[$key]->board_hit}}</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single List -->
    ...
    <div class="row">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                @forelse($data as $key => $val)
                    <tr>
                    <td>{{$data[$key]->board_id}}</td>
                    <td><a href="/board/{{$data[$key]->board_id}}">{{$data[$key]->board_title}}</a></td>
                    <td>{{$data[$key]->created_at}}</td>
                    <td>{{$data[$key]->board_hit}}</td>
                @empty
                    <tr>
                    <td></td>
                    <td>찜한 축제가 없습니다.</td>
